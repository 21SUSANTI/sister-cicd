...
$spreadsheet->setActiveSheetIndex(0)->setCellValue('A2', 'DAFTAR BUKU PERPUSTAKAAN SUSANTI| WEB C');
...
while ($row = mysqli_fetch_array($query)) {
	...
	->setCellValue('E'.$i, $row['pengarang'])
    ->setCellValue('F'.$i, $row['foto']);
	$i++; $no++;
}
